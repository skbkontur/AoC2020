...
namespace AoC_2020
{
    ...
    public class Task18
    {
                ...
                else
                {
                    switch (morpheme)
                    {
                        ...
                        case "*":
                            ...
                            break;
                        case "(":
                            var parenthesesExpression = TakeWhileZeroLevelParentheses(morphemes.Skip(i + 1)).ToArray();
        ...
        {
            yield return new TestCaseData(@"1 + 2 * 3 + 4 * 5 + 6").Returns(71);
            yield return new TestCaseData(@"1 + (2 * 3) + (4 * (5 + 6))").Returns(51);
            yield return new TestCaseData(@"2 * 3 + (4 * 5)").Returns(26);
            yield return new TestCaseData(@"5 + (8 * 3 + 9 + 3 * 4 * 3)").Returns(437);
            yield return new TestCaseData(@"5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))").Returns(12240);
            yield return new TestCaseData(@"((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2").Returns(13632);
...
(6 + 9 * 3 * (9 * 8 + 3) * (9 * 9 * 2)) * 8
4 + ((4 + 3 + 4 * 9 + 8) * 5 * 4 * 5 + 7 * 2) + (3 + 3 + (6 * 4) * 5 * 4 + 4) * 4 * ((6 * 6) + 5 + 4)").Returns(31142189909908);
        }
    }
}